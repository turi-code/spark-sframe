...
## Soft Dependency
The spark-sframe package leverages two binaries "spark_unity_linux" and "spark_unity_mac" which are directly built from the open-source [SFrame](https://github.com/dato-code/SFrame) package.
